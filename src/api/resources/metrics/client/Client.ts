...
export class MetricsClient {
     ...
     * ```
     *
     * @param {AgentMail.QueryRatesRequest} request
     * @param {MetricsClient.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link AgentMail.ValidationError}
     *
    ...
    public queryRates(
        ...
        return core.HttpResponsePromise.fromPromise(this.__queryRates(request, requestOptions));
    }
    ...
    private async __queryRates(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/v0/metrics/rates");
    }
}
