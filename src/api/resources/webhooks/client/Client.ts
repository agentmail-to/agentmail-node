...
export class Webhooks {
    ...
    public async list(
    ...
    ): Promise<core.Page<AgentMail.webhooks.Webhook, AgentMail.webhooks.ListWebhooksResponse>> {
        ...
        return new core.Page<AgentMail.webhooks.Webhook, AgentMail.webhooks.ListWebhooksResponse>({
