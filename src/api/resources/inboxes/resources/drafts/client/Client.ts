...
export class Drafts {
    ...
    public async list(
    ...
    ): Promise<core.Page<AgentMail.DraftItem, AgentMail.ListDraftsResponse>> {
            ...
            async (
                ...
                const _response = await core.fetcher({
                    url: core.url.join(
                        ...
                        `/v0/inboxes/${core.url.encodePathParam(serializers.inboxes.InboxId.jsonOrThrow(inboxId, { omitUndefined: true }))}/drafts`,
                    ),
                    method: "GET",
                    headers: _headers,
        ...
        return new core.Page<AgentMail.DraftItem, AgentMail.ListDraftsResponse>({
    ...
    private async __get(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/v0/inboxes/${core.url.encodePathParam(serializers.inboxes.InboxId.jsonOrThrow(inboxId, { omitUndefined: true }))}/drafts/${core.url.encodePathParam(serializers.DraftId.jsonOrThrow(draftId, { omitUndefined: true }))}`,
            ),
            method: "GET",
            headers: _headers,
    ...
    private async __send(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/v0/inboxes/${core.url.encodePathParam(serializers.inboxes.InboxId.jsonOrThrow(inboxId, { omitUndefined: true }))}/drafts/${core.url.encodePathParam(serializers.DraftId.jsonOrThrow(draftId, { omitUndefined: true }))}/send`,
            ),
            method: "POST",
            headers: _headers,
            contentType: "application/json",
