            ...
            async (
                ...
                const _response = await core.fetcher({
                    url: core.url.join(
                        ...
                        `/v0/pods/${core.url.encodePathParam(serializers.pods.PodId.jsonOrThrow(podId, { omitUndefined: true }))}/drafts`,
                    ),
                    method: "GET",
                    headers: _headers,
                ...
                switch (_response.error.reason) {
                    ...
                    case "timeout":
                        throw new errors.AgentMailTimeoutError(
                            "Timeout exceeded when calling GET /v0/pods/{pod_id}/drafts.",
                        );
                    case "unknown":
                        throw new errors.AgentMailError({
    ...
    private async __get(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/v0/pods/${core.url.encodePathParam(serializers.pods.PodId.jsonOrThrow(podId, { omitUndefined: true }))}/drafts/${core.url.encodePathParam(serializers.DraftId.jsonOrThrow(draftId, { omitUndefined: true }))}`,
            ),
            method: "GET",
            headers: _headers,
