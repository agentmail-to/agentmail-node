...
export class Threads {
    ...
    public async list(
    ...
    ): Promise<core.Page<AgentMail.ThreadItem, AgentMail.ListThreadsResponse>> {
            ...
            async (
                ...
                const _response = await core.fetcher({
                    url: core.url.join(
                        ...
                        `/v0/pods/${core.url.encodePathParam(serializers.pods.PodId.jsonOrThrow(podId, { omitUndefined: true }))}/threads`,
                    ),
                    method: "GET",
                    headers: _headers,
                ...
                switch (_response.error.reason) {
                    ...
                    case "timeout":
                        throw new errors.AgentMailTimeoutError(
                            "Timeout exceeded when calling GET /v0/pods/{pod_id}/threads.",
                        );
                    case "unknown":
                        throw new errors.AgentMailError({
        ...
        return new core.Page<AgentMail.ThreadItem, AgentMail.ListThreadsResponse>({
    ...
    private async __get(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/v0/pods/${core.url.encodePathParam(serializers.pods.PodId.jsonOrThrow(podId, { omitUndefined: true }))}/threads/${core.url.encodePathParam(serializers.ThreadId.jsonOrThrow(threadId, { omitUndefined: true }))}`,
            ),
            method: "GET",
            headers: _headers,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.AgentMailTimeoutError(
                    "Timeout exceeded when calling GET /v0/pods/{pod_id}/threads/{thread_id}.",
                );
            case "unknown":
                throw new errors.AgentMailError({
                    message: _response.error.errorMessage,
    ...
    public getAttachment(
        ...
        return core.HttpResponsePromise.fromPromise(
            this.__getAttachment(podId, threadId, attachmentId, requestOptions),
        );
    }
    ...
    private async __getAttachment(
        ...
        const _response = await core.fetcher<core.BinaryResponse>({
            url: core.url.join(
                ...
                `/v0/pods/${core.url.encodePathParam(serializers.pods.PodId.jsonOrThrow(podId, { omitUndefined: true }))}/threads/${core.url.encodePathParam(serializers.ThreadId.jsonOrThrow(threadId, { omitUndefined: true }))}/attachments/${core.url.encodePathParam(serializers.AttachmentId.jsonOrThrow(attachmentId, { omitUndefined: true }))}`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.AgentMailTimeoutError(
                    "Timeout exceeded when calling GET /v0/pods/{pod_id}/threads/{thread_id}/attachments/{attachment_id}.",
                );
            case "unknown":
                throw new errors.AgentMailError({
                    message: _response.error.errorMessage,
