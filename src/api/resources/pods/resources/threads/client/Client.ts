...
export class ThreadsClient {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                (await core.Supplier.get(this._options.baseUrl)) ??
                    ((await core.Supplier.get(this._options.environment)) ?? environments.AgentMailEnvironment.Prod)
                        .http,
                `/v0/pods/${core.url.encodePathParam(serializers.pods.PodId.jsonOrThrow(pod_id, { omitUndefined: true }))}/threads/search`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: { ..._queryParams, ...requestOptions?.queryParams },
    ...
    public update(
        ...
        requestOptions?: ThreadsClient.RequestOptions,
    ): core.HttpResponsePromise<AgentMail.UpdateThreadResponse> {
    ...
    private async __update(
        ...
        request: AgentMail.UpdateThreadRequest,
        requestOptions?: ThreadsClient.RequestOptions,
    ): Promise<core.WithRawResponse<AgentMail.UpdateThreadResponse>> {
        const _authRequest: core.AuthRequest = await this._options.authProvider.getAuthRequest();
        const _headers: core.Fetcher.Args["headers"] = mergeHeaders(
            _authRequest.headers,
            this._options?.headers,
