            ...
            async (
                ...
                const _response = await core.fetcher({
                    url: core.url.join(
                        ...
                        `/v0/pods/${encodeURIComponent(serializers.pods.PodId.jsonOrThrow(podId, { omitUndefined: true }))}/threads`,
                    ),
                    method: "GET",
                    headers: _headers,
    ...
    private async __get(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/v0/pods/${encodeURIComponent(serializers.pods.PodId.jsonOrThrow(podId, { omitUndefined: true }))}/threads/${encodeURIComponent(serializers.ThreadId.jsonOrThrow(threadId, { omitUndefined: true }))}`,
            ),
            method: "GET",
            headers: _headers,
    ...
    private async __getAttachment(
        ...
        const _response = await core.fetcher<core.BinaryResponse>({
            url: core.url.join(
                ...
                `/v0/pods/${encodeURIComponent(serializers.pods.PodId.jsonOrThrow(podId, { omitUndefined: true }))}/threads/${encodeURIComponent(serializers.ThreadId.jsonOrThrow(threadId, { omitUndefined: true }))}/attachments/${encodeURIComponent(serializers.AttachmentId.jsonOrThrow(attachmentId, { omitUndefined: true }))}`,
            ),
            method: "GET",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
