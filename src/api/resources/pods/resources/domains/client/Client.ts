...
export class Domains {
    ...
    public async list(
    ...
    ): Promise<core.Page<AgentMail.ListDomainsResponse, AgentMail.DomainSummary>> {
            ...
            async (
                ...
                const _response = await core.fetcher({
                    url: core.url.join(
                        ...
                        `/v0/pods/${core.url.encodePathParam(serializers.pods.PodId.jsonOrThrow(podId, { omitUndefined: true }))}/domains`,
                    ),
                    method: "GET",
                    headers: _headers,
        ...
        return new core.Page<AgentMail.ListDomainsResponse, AgentMail.DomainSummary>({
    ...
    private async __create(
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.AgentMailTimeoutError("Timeout exceeded when calling POST /v0/pods/{pod_id}/domains.");
            case "unknown":
                throw new errors.AgentMailError({
                    message: _response.error.errorMessage,
                    rawResponse: _response.rawResponse,
    ...
    private async __delete(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `/v0/pods/${core.url.encodePathParam(serializers.pods.PodId.jsonOrThrow(podId, { omitUndefined: true }))}/domains/${core.url.encodePathParam(serializers.DomainId.jsonOrThrow(domainId, { omitUndefined: true }))}`,
            ),
            method: "DELETE",
            headers: _headers,
            queryParameters: requestOptions?.queryParams,
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.AgentMailTimeoutError(
                    "Timeout exceeded when calling DELETE /v0/pods/{pod_id}/domains/{domain_id}.",
                );
            case "unknown":
                throw new errors.AgentMailError({
                    message: _response.error.errorMessage,
