...
describe("ThreadsClient", () => {
    ...
    test("list (2)", async () => {
        ...
        await expect(async () => {
            return await client.pods.threads.list("pod_id");
    ...
    test("search (1)", async () => {
        ...
        const response = await client.pods.threads.search("pod_id", {
            q: "q",
        });
        expect(response).toEqual({
            count: 1,
    ...
    test("search (2)", async () => {
        ...
        await expect(async () => {
            return await client.pods.threads.search("pod_id", {
                q: "q",
            });
    ...
    test("get (1)", async () => {
        ...
        const response = await client.pods.threads.get("pod_id", "thread_id");
        expect(response).toEqual({
            inboxId: "inbox_id",
            threadId: "thread_id",
            labels: ["labels", "labels"],
    ...
    test("get (2)", async () => {
        ...
        await expect(async () => {
            return await client.pods.threads.get("pod_id", "thread_id");
        }).rejects.toThrow(AgentMail.NotFoundError);
    });
    ...
    test("getAttachment (1)", async () => {
        ...
        const response = await client.pods.threads.getAttachment("pod_id", "thread_id", "attachment_id");
        expect(response).toEqual({
            attachmentId: "attachment_id",
            filename: "filename",
            size: 1,
    ...
    test("getAttachment (2)", async () => {
        ...
        await expect(async () => {
            return await client.pods.threads.getAttachment("pod_id", "thread_id", "attachment_id");
        }).rejects.toThrow(AgentMail.NotFoundError);
    });
    ...
    test("update (1)", async () => {
        ...
        const response = await client.pods.threads.update("pod_id", "thread_id", {});
        expect(response).toEqual({
            threadId: "thread_id",
            labels: ["labels", "labels"],
        });
    ...
    test("update (2)", async () => {
        ...
        await expect(async () => {
            return await client.pods.threads.update("pod_id", "thread_id", {});
        }).rejects.toThrow(AgentMail.ValidationError);
    });
    ...
    test("delete (1)", async () => {
        ...
        server.mockEndpoint().delete("/v0/pods/pod_id/threads/thread_id").respondWith().statusCode(200).build();

        const response = await client.pods.threads.delete("pod_id", "thread_id");
    ...
    test("delete (2)", async () => {
        ...
        await expect(async () => {
            return await client.pods.threads.delete("pod_id", "thread_id");
        }).rejects.toThrow(AgentMail.NotFoundError);
    });
});
