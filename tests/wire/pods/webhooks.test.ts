...
describe("WebhooksClient", () => {
    test("list", async () => {
        ...
        const response = await client.pods.webhooks.list("pod_id");
    ...
    test("get (1)", async () => {
        ...
        const response = await client.pods.webhooks.get("pod_id", "webhook_id");
        expect(response).toEqual({
            webhookId: "webhook_id",
            url: "url",
            eventTypes: ["message.received", "message.received"],
    ...
    test("get (2)", async () => {
        ...
        await expect(async () => {
            return await client.pods.webhooks.get("pod_id", "webhook_id");
    ...
    test("create (1)", async () => {
        ...
        const response = await client.pods.webhooks.create("pod_id", {
            url: "url",
            eventTypes: ["message.received", "message.received"],
        });
        expect(response).toEqual({
    ...
    test("create (2)", async () => {
        ...
        await expect(async () => {
            return await client.pods.webhooks.create("pod_id", {
                url: "url",
                eventTypes: ["message.received", "message.received"],
            });
    ...
    test("update (1)", async () => {
        ...
        const response = await client.pods.webhooks.update("pod_id", "webhook_id", {});
        expect(response).toEqual({
            webhookId: "webhook_id",
            url: "url",
            eventTypes: ["message.received", "message.received"],
    ...
    test("delete (1)", async () => {
        ...
        server.mockEndpoint().delete("/v0/pods/pod_id/webhooks/webhook_id").respondWith().statusCode(200).build();

        const response = await client.pods.webhooks.delete("pod_id", "webhook_id");
    ...
    test("delete (2)", async () => {
        ...
        await expect(async () => {
            return await client.pods.webhooks.delete("pod_id", "webhook_id");
        }).rejects.toThrow(AgentMail.NotFoundError);
    });
});
