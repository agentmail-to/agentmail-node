...
describe("AccountsClient", () => {
    test("list (1)", async () => {
        ...
        const response = await client.pods.accounts.list("pod_id");
    ...
    test("list (2)", async () => {
        ...
        await expect(async () => {
            return await client.pods.accounts.list("pod_id");
    ...
    test("get (1)", async () => {
        ...
        server
            .mockEndpoint()
            .get("/v0/pods/pod_id/accounts/d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();
    ...
    test("get (2)", async () => {
        ...
        await expect(async () => {
            return await client.pods.accounts.get("pod_id", "d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32");
