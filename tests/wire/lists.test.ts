...
describe("ListsClient", () => {
    ...
    test("list", async () => {
        ...
        const response = await client.lists.list("send", "allow");
        expect(response).toEqual({
            count: 1,
            limit: 1,
    ...
    test("get (1)", async () => {
        ...
        const response = await client.lists.get("send", "allow", "entry");
        expect(response).toEqual({
            entry: "entry",
            organizationId: "organization_id",
            reason: "reason",
    ...
    test("delete (1)", async () => {
        ...
        server.mockEndpoint().delete("/v0/lists/send/allow/entry").respondWith().statusCode(200).build();

        const response = await client.lists.delete("send", "allow", "entry");
    ...
    test("delete (2)", async () => {
        ...
        await expect(async () => {
            return await client.lists.delete("send", "allow", "entry");
        }).rejects.toThrow(AgentMail.NotFoundError);
    });
});
