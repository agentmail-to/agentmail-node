...
describe("DraftsClient", () => {
    ...
    test("getAttachment (1)", async () => {
        ...
        const response = await client.inboxes.drafts.getAttachment("inbox_id", "draft_id", "attachment_id");
        expect(response).toEqual({
            attachmentId: "attachment_id",
            filename: "filename",
            size: 1,
    ...
    test("getAttachment (2)", async () => {
        ...
        await expect(async () => {
            return await client.inboxes.drafts.getAttachment("inbox_id", "draft_id", "attachment_id");
        }).rejects.toThrow(AgentMail.NotFoundError);
    });
