...
describe("WebhooksClient", () => {
    test("list", async () => {
        ...
        const response = await client.inboxes.webhooks.list("inbox_id");
    ...
    test("get (1)", async () => {
        ...
        const response = await client.inboxes.webhooks.get("inbox_id", "webhook_id");
        expect(response).toEqual({
            webhookId: "webhook_id",
            url: "url",
            eventTypes: ["message.received", "message.received"],
    ...
    test("get (2)", async () => {
        ...
        await expect(async () => {
            return await client.inboxes.webhooks.get("inbox_id", "webhook_id");
    ...
    test("getHeaders (1)", async () => {
        ...
        const response = await client.inboxes.webhooks.getHeaders("inbox_id", "webhook_id");
        expect(response).toEqual({
    ...
    test("getHeaders (2)", async () => {
        ...
        await expect(async () => {
            return await client.inboxes.webhooks.getHeaders("inbox_id", "webhook_id");
        }).rejects.toThrow(AgentMail.NotFoundError);
    });
    ...
    test("create (1)", async () => {
        ...
        const response = await client.inboxes.webhooks.create("inbox_id", {
            url: "url",
            eventTypes: ["message.received", "message.received"],
        });
        expect(response).toEqual({
    ...
    test("create (2)", async () => {
        ...
        await expect(async () => {
            return await client.inboxes.webhooks.create("inbox_id", {
                url: "url",
                eventTypes: ["message.received", "message.received"],
            });
    ...
    test("update (1)", async () => {
        ...
        const response = await client.inboxes.webhooks.update("inbox_id", "webhook_id", {});
        expect(response).toEqual({
            webhookId: "webhook_id",
            url: "url",
            eventTypes: ["message.received", "message.received"],
    ...
    test("update (2)", async () => {
        ...
        await expect(async () => {
            return await client.inboxes.webhooks.update("inbox_id", "webhook_id", {});
        }).rejects.toThrow(AgentMail.NotFoundError);
    });
    ...
    test("updateHeaders (1)", async () => {
        ...
        const response = await client.inboxes.webhooks.updateHeaders("inbox_id", "webhook_id", {});
    ...
    test("updateHeaders (2)", async () => {
        ...
        await expect(async () => {
            return await client.inboxes.webhooks.updateHeaders("inbox_id", "webhook_id", {});
        }).rejects.toThrow(AgentMail.NotFoundError);
    });
    ...
    test("delete (1)", async () => {
        ...
        server.mockEndpoint().delete("/v0/inboxes/inbox_id/webhooks/webhook_id").respondWith().statusCode(200).build();

        const response = await client.inboxes.webhooks.delete("inbox_id", "webhook_id");
        expect(response).toEqual(undefined);
    });
    ...
    test("delete (2)", async () => {
        ...
        await expect(async () => {
            return await client.inboxes.webhooks.delete("inbox_id", "webhook_id");
        }).rejects.toThrow(AgentMail.NotFoundError);
    });
});
