...
describe("AccountsClient", () => {
    test("list (1)", async () => {
        ...
        const response = await client.inboxes.accounts.list("inbox_id");
    ...
    test("list (2)", async () => {
        ...
        await expect(async () => {
            return await client.inboxes.accounts.list("inbox_id");
    ...
    test("get (1)", async () => {
        ...
        server
            .mockEndpoint()
            .get("/v0/inboxes/inbox_id/accounts/d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.inboxes.accounts.get("inbox_id", "d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32");
        expect(response).toEqual({
            accountId: "d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32",
            providerId: "d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32",
            providerName: "provider_name",
    ...
    test("get (2)", async () => {
        ...
        await expect(async () => {
            return await client.inboxes.accounts.get("inbox_id", "d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32");
