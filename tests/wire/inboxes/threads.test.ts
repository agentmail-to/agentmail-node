...
describe("ThreadsClient", () => {
    ...
    test("search (1)", async () => {
        ...
        const response = await client.inboxes.threads.search("inbox_id", {
            q: "q",
        });
        expect(response).toEqual({
            count: 1,
    ...
    test("search (2)", async () => {
        ...
        await expect(async () => {
            return await client.inboxes.threads.search("inbox_id", {
                q: "q",
            });
    ...
    test("getAttachment (1)", async () => {
        ...
        const response = await client.inboxes.threads.getAttachment("inbox_id", "thread_id", "attachment_id");
        expect(response).toEqual({
            attachmentId: "attachment_id",
            filename: "filename",
            size: 1,
    ...
    test("getAttachment (2)", async () => {
        ...
        await expect(async () => {
            return await client.inboxes.threads.getAttachment("inbox_id", "thread_id", "attachment_id");
        }).rejects.toThrow(AgentMail.NotFoundError);
    });
    ...
    test("update (1)", async () => {
        ...
        const response = await client.inboxes.threads.update("inbox_id", "thread_id", {});
        expect(response).toEqual({
            threadId: "thread_id",
            labels: ["labels", "labels"],
        });
    ...
    test("update (2)", async () => {
        ...
        await expect(async () => {
            return await client.inboxes.threads.update("inbox_id", "thread_id", {});
        }).rejects.toThrow(AgentMail.ValidationError);
    });
